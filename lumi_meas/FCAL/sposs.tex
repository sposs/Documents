...
\begin{frame}
\frametitle{First method: brute force fit}
\begin{figure}[h]
...
\begin{frame}
\frametitle{Need an other approach}
\begin{itemize}
  \item Cannot afford running the procedure for years
  \item Need proper alternative
\end{itemize}
~\\
\begin{center}
\alert{Use reweighting fit}
\end{center}
\end{frame}
...
\begin{frame}
\frametitle{Second approach: reweighting fit}\label{slide:reweightingfit}
