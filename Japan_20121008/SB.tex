...
% ILC made software availalble to us
  \item \alert{Convenient interface} to handle 12 ILC applications (Mokka, Marlin, SLIC, etc.)
  \begin{itemize}
...
\end{itemize}
~\\
More than {\color{blue}90 million events (ILC and CLIC) processed in 2.5 year}\\%event number instead
%%add plot
~\\
...
FIXME
%\hskip 0.3\textwidth
%\includegraphics[with=0.\textwidth]{LumiSpectrum}
  \end{frame}
}
