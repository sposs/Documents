...
\begin{enumerate}
  \item 2001-2004, Physics Bachelor (Universit\'e de la M\'editerrann\'ee)
...
\begin{itemize}
  ...
  \alert{DIRAC client for the ILC~VO}:\\ 
  \begin{itemize}  
...
\item Now \alert{adopted by the ILC SID community} for their Detailed Baseline
  Detector document mass production
\end{itemize}
~\\
More than {\color{blue}6 million jobs processed in 2.5 year}: CLIC CDR
production, SID DBD production and user jobs.\\
~\\ 
...
Development:
\begin{itemize}
\item DIRAC mass production system
\item Improve user interface
\item Data management: popularity
\end{itemize}
~\\
Operations:
\begin{itemize}
\item Interface with Computing Elements: Amazon EC2, GRID
...
\begin{frame}
  ...
  \begin{itemize}
  \item Knowledge of the experimental conditions
